...
{
    public class UdpAtonSocketClient : SocketClientBase
    {
        Socket m_Socket;
        ...
        public UdpAtonSocketClient(string ipAddress, int port) : base(ipAddress, port)
        {
        ...
        private void M_SocketAsyncEventArgs_Completed(object sender, SocketAsyncEventArgs e)
        {
            ...
            {
                case SocketAsyncOperation.ReceiveFrom://recv finish
                    ProcessRecv(e);
                    break;
                case SocketAsyncOperation.SendTo://sent finish
                    ProcessRequest(e);
                    break;
                default:
        ...
        public override SocketResult Connect(byte[] data)
        {
            ...
            try
            {
                if (m_Socket.SendTo(data, remoteEndPoint) == data.Length)
                {
                    ...
                    string dataServer = ASCIIEncoding.ASCII.GetString(m_SocketBuffer, 0, recvNum);
